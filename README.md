...
Load balancers protect the Availability aspect of the CIA triad by routing traffic equally among each web server. One advantage of implementing a Jump Box is the ability to deploy ansible and effeciently manage Web Servers.
